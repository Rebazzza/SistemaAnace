 ...
 * @author ma5ti
 */
public class GUIMostrarVenta extends javax.swing.JFrame {

    /**
     * Creates new form GUIMostrarVenta
     */
    Empleado em = new Empleado();
    VentaController vc =  new VentaController();
    public GUIMostrarVenta(Empleado e) {
        initComponents();
        int codigoEmpleado = e.getCodigo();
        DefaultTableModel modeloVentas = vc.obtenerVentasPorEmpleado(codigoEmpleado);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Buscar Detalle venta");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GUIMostrarDetalle(jTextField1.getText().trim()).setVisible(true);
